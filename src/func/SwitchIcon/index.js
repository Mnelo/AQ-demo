...
const DirIcon = ({ size }) => (
  <IconFont type="icon-Folder" style={{ fontSize: size }} />
); // 文件夹
const SheetIcon = ({ size }) => (
  <IconFont type="icon-DataSheet" style={{ fontSize: size }} />
); // 数据库表

const WordIcon = ({ size }) => (
  <IconFont type="icon-word" style={{ fontSize: size }} />
); // word文件
const CsvIcon = ({ size }) => (
  <IconFont type="icon-csv" style={{ fontSize: size }} />
); // csv文件
const JsonIcon = ({ size }) => (
  <IconFont type="icon-json" style={{ fontSize: size }} />
); // json文件
const XlsIcon = ({ size }) => (
  <IconFont type="icon-xls" style={{ fontSize: size }} />
); // excel文件
const TextIcon = ({ size }) => (
  <IconFont type="icon-txt" style={{ fontSize: size }} />
); // txt文件
const PdfIcon = ({ size }) => (
  <IconFont type="icon-pdf" style={{ fontSize: size }} />
); // pdf文件
const PptIcon = ({ size }) => (
  <IconFont type="icon-ppt" style={{ fontSize: size }} />
); // ppt文件
const HtmlIcon = ({ size }) => (
  <IconFont type="icon-html" style={{ fontSize: size }} />
); // html文件
const VideoIcon = ({ size }) => (
  <IconFont type="icon-shipin" style={{ fontSize: size }} />
); // 视频
const AudioIcon = ({ size }) => (
  <IconFont type="icon-yinpin" style={{ fontSize: size }} />
); // 音频
const AiIcon = ({ size }) => (
  <IconFont type="icon-ai" style={{ fontSize: size }} />
); // ai文件
const ImgIcon = ({ size }) => (
  <IconFont type="icon-tupian" style={{ fontSize: size }} />
); // 图片
const ExeIcon = ({ size }) => (
  <IconFont type="icon-exechengxu" style={{ fontSize: size }} />
); // 程序
const PsIcon = ({ size }) => (
  <IconFont type="icon-ps" style={{ fontSize: size }} />
); // ps文件
const PressIcon = ({ size }) => (
  <IconFont type="icon-yasuo" style={{ fontSize: size }} />
); // 压缩文件
const CadIcon = ({ size }) => (
  <IconFont type="icon-cad" style={{ fontSize: size }} />
); // cad文件
const UnknownIcon = ({ size }) => (
  <IconFont type="icon-weizhileixing" style={{ fontSize: size }} />
); // 未知文件
